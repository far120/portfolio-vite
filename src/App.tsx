    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white font-sans">
      ...
      <main className="max-w-5xl mx-auto px-4">
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6 bg-gradient-to-r from-blue-900/60 via-transparent to-blue-900/60 rounded-t-xl px-4 py-2 shadow-lg">
            <h2 className="text-2xl font-semibold border-b-2 border-blue-500 pb-2 text-blue-300 uppercase tracking-widest">About Me</h2>
            <button onClick={() => setShowAbout(v => !v)} className="ml-4 px-4 py-1 rounded-lg bg-blue-700/60 hover:bg-blue-500/80 text-white font-semibold shadow transition flex items-center gap-2">
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6 bg-gradient-to-r from-blue-900/60 via-transparent to-blue-900/60 rounded-t-xl px-4 py-2 shadow-lg">
            <h2 className="text-2xl font-semibold border-b-2 border-blue-500 pb-2 text-blue-300 uppercase tracking-widest">Work Experience</h2>
            <button onClick={() => setShowWork(v => !v)} className="ml-4 px-4 py-1 rounded-lg bg-blue-700/60 hover:bg-blue-500/80 text-white font-semibold shadow transition flex items-center gap-2">
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6 bg-gradient-to-r from-blue-900/60 via-transparent to-blue-900/60 rounded-t-xl px-4 py-2 shadow-lg">
            <h2 className="text-2xl font-semibold border-b-2 border-blue-500 pb-2 text-blue-300 uppercase tracking-widest">Projects</h2>
            <button onClick={() => setShowProjects(v => !v)} className="ml-4 px-4 py-1 rounded-lg bg-blue-700/60 hover:bg-blue-500/80 text-white font-semibold shadow transition flex items-center gap-2">
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6 bg-gradient-to-r from-blue-900/60 via-transparent to-blue-900/60 rounded-t-xl px-4 py-2 shadow-lg">
            <h2 className="text-2xl font-semibold border-b-2 border-blue-500 pb-2 text-blue-300 uppercase tracking-widest">Skills</h2>
            <button onClick={() => setShowSkills(v => !v)} className="ml-4 px-4 py-1 rounded-lg bg-blue-700/60 hover:bg-blue-500/80 text-white font-semibold shadow transition flex items-center gap-2">
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6 bg-gradient-to-r from-blue-900/60 via-transparent to-blue-900/60 rounded-t-xl px-4 py-2 shadow-lg">
            <h2 className="text-2xl font-semibold border-b-2 border-blue-500 pb-2 text-blue-300 uppercase tracking-widest">Certifications</h2>
            <button onClick={() => setShowCerts(v => !v)} className="ml-4 px-4 py-1 rounded-lg bg-blue-700/60 hover:bg-blue-500/80 text-white font-semibold shadow transition flex items-center gap-2">
